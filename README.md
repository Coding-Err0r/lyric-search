...
This is a simple project to showcase API to search lyrics for any song. This project is made with next js.
...
1. Clone repo
   ```sh
   git clone https://github.com/Coding-Err0r/lyric-search.git
   ```
...
Project Link: [Porject Link](https://github.com/Coding-Err0r/lyric-search.git)
